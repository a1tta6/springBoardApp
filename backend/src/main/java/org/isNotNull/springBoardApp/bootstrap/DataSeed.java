...
public final class DataSeed implements CommandLineRunner {
    ...
    public void run(final String... arguments) {
        ...
        final CompanyEntity techno = this.companies.save(new CompanyEntity(
            ...
            "7701234567",
            "1177746358590",
            "Россия, Москва, ул. Примерная, д. 1",
            55.751244, 37.618423,
            "https://technolab.ru",
            null,
        ...
        final CompanyEntity code = this.companies.save(new CompanyEntity(
            ...
            null,
            null,
            "Россия, Москва, ул. Образовательная, д. 3",
            55.7558, 37.6173,
            "https://codemaster.ru",
            null,
        ...
        final CompanyEntity startup = this.companies.save(new CompanyEntity(
            ...
            null,
            null,
            "Россия, Москва, ул. Стартаповая, д. 4",
            55.7530, 37.6200,
            "https://startuphub.ru",
            null,
        ...
        this.opportunities.save(new OpportunityEntity(
            ...
            startup.id(),
            WorkFormat.OFFICE,
            "Казань, Технопарк Идея, корпус 7",
            "Казань",
            55.796127,
            49.106414,
            null,
